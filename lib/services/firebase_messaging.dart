...
import 'package:derapidos/services/fcm_model.dart';
...
String deviceToken='N1iPXE5GkhehXbUXe3YPf6E26ZIlFtnls5Gnf48sgJfThB9noTy16OQULKhh';
class FCM {
  ...
  Future sendNotificationFCM(String token, String title, String body, int type,
    ...
    final response = await http
      ...
      headers: <String, String>{
        ...
        'Authorization':
        'Bearer AAAAu29MoxY:APA91bG9Cd4wPVLvfexSDMFXPw2gI0str-h6X2_4XcAvj-uCQwO-DhB88pAgqQnD3aqv3G2uyW1nGgr9qNnxAAKCwN_dALB6yWu8kAJpMVFnD6c8-YeQVHdpw7qOHoZ1tlKdTUxROKhk',
      },
