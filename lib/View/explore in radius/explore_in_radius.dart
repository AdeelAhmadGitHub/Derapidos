...
import '../../models/real_estate_models/category_model.dart';
...
import '../RestaurantTypeScreen/RestaurantTypeScreen.dart';
import '../Store Details/store_detail_screen.dart';
import '../awards/awards_screen.dart';

class ExploreInRadius extends StatefulWidget {
  const ExploreInRadius({Key? key}) : super(key: key);

  @override
  State<ExploreInRadius> createState() => _ExploreInRadiusState();
}

class _ExploreInRadiusState extends State<ExploreInRadius> {
  int? selectedIndex;
  int checkedIndex = 0;
  var _current = 0;
  double slider = 0;
  ...
  gotcallf() async {
    ...
    if (isLogin == false) {
      ...
      homeController.getHomeRadiusData();
    } else {
      ...
      homeController.getHomeRadiusData1();
    }
  }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                              ...
                              Expanded(
                                child: SliderTheme(
                                  ...
                                  child: Slider(
                                      ...
                                      inactiveColor: AppColors().mainColor2.withOpacity(0.5),
                                      value: slider,
                              ...
                              Padding(
                                ...
                                child: CustomCard(
                                    ...
                                    cardChild: GestureDetector(
                                      onTap: () {
                                        radiusvalue = slider.toInt().toString();
                                        log('radius value: $radiusvalue');
                                        log('date: $dateStr');
                                        homeController.radius = radiusvalue;
                                        homeController.product_date = dateStr;
                                        gotcallf();
                                      },
                                      child: Center(
                                        child: CustomText(
                          ...
                          SizedBox(
                            child: homeController.homepageproduct!.value.data!.products!.isEmpty
                                ? const Center(
                                    child: CustomText(
                                      text: "No menu",
                                    ),
                                ...
                                : Container(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      scrollDirection: Axis.horizontal,
                                      itemCount: homeController.homepageproduct!.value.data!.products!.length,
                                      // 10,
                                      itemBuilder: (BuildContext context, int index) {
                                        Products product =
                                            homeController.homepageproduct!.value.data!.products![index];
                                        return GestureDetector(
                                          onTap: () {
                                            selectedIndex = index;
                                            setState(() {});
                                            //var homeController = Get.put(HomeController());
                                            homeController.categorytypeid = homeController
                                                .currentRestaurantId = product.marketId.toString();
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    homeController.categorytype = "1";
                                    homeController.markettype = "Local Cuisines";
                                    homeController.restaurant_sub_type = "";
                                    Get.to(const GetStoreHomebyCategory());
                                  },
                                  child: CustomText4(
