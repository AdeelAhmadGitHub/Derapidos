import 'package:derapidos/View/Home/home_screenmarket.dart';
...
class NavigationbarScreenMarket extends StatefulWidget {
  const NavigationbarScreenMarket({Key? key}) : super(key: key);

  @override
  State<NavigationbarScreenMarket> createState() => _NavigationbarScreenState();
}

class _NavigationbarScreenState extends State<NavigationbarScreenMarket> {
  int _selectedIndex = 0;

  final screen = [
    const HomeScreenMarket(),
    const OrdersScreen(),
    const MycartScreen(),
    const Profile(),
  ];
