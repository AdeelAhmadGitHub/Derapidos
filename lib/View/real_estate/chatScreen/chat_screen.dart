...
import 'package:derapidos/View/real_estate/chatScreen/full_media_display.dart';
...
import 'package:derapidos/widget/message_field.dart';
...
class _ChattingScreenState extends State<ChattingScreen> {
  ...
  initState() {
    ...
    //   });
    // });
    userMsgId = chatController.usermsgId;
  ...
  sendMessage(String? messageDataType) async {
    ...
    final doc = await FirebaseFirestore.instance.collection('userslist').doc('${widget.driverId}').get();
    print('send message doc $doc');

    /// fcm token hide
    // var fcmToken = doc.get('fcm_token');
