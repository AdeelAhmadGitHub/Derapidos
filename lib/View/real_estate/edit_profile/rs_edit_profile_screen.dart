...
import 'package:derapidos/services/firebase_messaging.dart';
...
import '../../../controllers/r_s_controller/profile_controller.dart';
import '../../../services/api_services.dart';
import '../../../user_prefs/user_prefs.dart';
import '../../Custom Widget/custom_text.dart';

class RsEditProfileScreen extends StatefulWidget {
  const RsEditProfileScreen({Key? key}) : super(key: key);

  @override
  State<RsEditProfileScreen> createState() => _EditProfileScreen();
}

class _EditProfileScreen extends State<RsEditProfileScreen> {
  ...
  initState() {
    ...
    homeController.rsEditProfileLoading.value = false;
  ...
  Widget build(BuildContext context) {
    return GetX<ProfileController>(
      builder: (controller) {
        return homeController.rsEditProfileLoading.value
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 20.h),
                          controller.rsEditProfileLoading.value
                              //     ? const CircularProgressIndicator()
                              //     :
                              // _isloading
                              ? const CircularProgressIndicator()
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: MyCustomButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        _isloading = true;
                                        _redraw();
                                        homeController.rsEditProfile(
                                            _imageFile!.path, name!, email!, phone!, password!);
