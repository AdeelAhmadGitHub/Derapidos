...
import 'package:derapidos/View/explore%20in%20radius/explore_in_radius.dart';
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                                  ...
                                  Flexible(
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        prefixIcon:
                                            Icon(Icons.search, size: 20, color: AppColors().mainColor2),
                                      ),
                                    ),
                                  ),
                                  Container(
                          ...
                          SizedBox(height: 10.h),
                          Wrap(
                            spacing: 4.w, // gap between adjacent chips
                            // runSpacing: 4.0, // gap between lines
                            children: <Widget>[
                              InkWell(
                                onTap: () {
                                  homeController.loadingR.value = true;
                                  homeController.restaurant_sub_type = "Specials";
                                  homeController.categorytype = "1";
                                  homeController.markettype = "";
                                  homeController.radius = "";
                                  homeController.product_date = "";
                                  Get.to(const RestaurantTypeScreen());
                                },
                              ...
                              InkWell(
                                onTap: () {
                                  homeController.loadingR.value = true;
                                  homeController.restaurant_sub_type = "Breakfast";
                                  homeController.categorytype = "1";
                                  homeController.markettype = "";
                                  homeController.radius = "";
                                  homeController.product_date = "";
                              ...
                              InkWell(
                                onTap: () => Get.to(const AwardsScreen()),
                                child: buildCustomCard(
                                  "Promo",
                                                                        ...
                                                                        InkWell(
                                                                          onTap: () async {
                                                                            ...
                                                                            if (isLogin == false) {
                                                                              ...
                                                                              setState(() {});
                                                                              homeController.restaurantIDF = restaurant.id;
                                                                              homeController.addRemoveFavorite();
                                                                            }
                                                                          },
                                                                          child: SizedBox(
                                                                              height: 20.h,
                                                                              child: restaurant.favourite == 0
                                                                                  ? Image.asset(
                                                                                  "assets/images/like0.png")
                                                                                  : Image.asset(
                                                                                  "assets/images/like2.png")),
