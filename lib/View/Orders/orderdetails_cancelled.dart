...
class OrderdetailsCancelled extends StatefulWidget {
  const OrderdetailsCancelled({Key? key}) : super(key: key);

  @override
  State<OrderdetailsCancelled> createState() => _OrderdetailsCancelledState();
}

class _OrderdetailsCancelledState extends State<OrderdetailsCancelled> {
  @override
