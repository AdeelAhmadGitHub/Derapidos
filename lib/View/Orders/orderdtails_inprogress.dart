...
class OrderdetailsInprogress extends StatefulWidget {
  const OrderdetailsInprogress({Key? key}) : super(key: key);

  @override
  State<OrderdetailsInprogress> createState() => _OrderdetailsInprogressState();
}

class _OrderdetailsInprogressState extends State<OrderdetailsInprogress> {
  @override
